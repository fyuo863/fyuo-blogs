...
- A damped two-dimensional wave-heightfield periodically injects a source at the left edge, so the title dots carry rightward-propagating ripples without moving their centres.
