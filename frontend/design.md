...
- The Cover Flow stage carries a static solid-colour moire field made from overlapping cobalt and vermilion hairlines. Each cover extends a clipped mirrored reflection below its lower edge; the same moire lines colour and dissolve that reflection instead of adding a separate translucent surface.
