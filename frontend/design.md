...
- The title uses a compact default dot radius (0.39 cell) over cobalt. A damped two-dimensional wave-heightfield injects stronger sources at randomized intervals along the left edge; stronger wave peaks shrink the fixed-centre title dots to reveal more cobalt.
