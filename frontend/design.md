...
- Selected work is arranged as a sequence of facing-page pairs: recto uses image then copy; verso uses copy then image. Desktop pages use the ISO A-series 1:√2 portrait ratio, with a generous paper gutter between pages and between spreads.
